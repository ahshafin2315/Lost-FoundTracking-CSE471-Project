...
class VerificationService:
    ...
    def update_claim_status(self, post_id, claim_id, new_status):
        ...
        if new_status == 'approved':
            ...
            self._create_approval_notifications(claim, post)

        return self.verification_repository.update_claim_status(claim_id, new_status)

    def _create_approval_notifications(self, claim, post):
        notifications = [
            {
        ...
        for notification_data in notifications:
            self.verification_repository.create_notification(notification_data)
